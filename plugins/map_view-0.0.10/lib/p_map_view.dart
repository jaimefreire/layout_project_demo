...
class PMapView {
  ...
  StreamController<PLocation> _LocationChangeStreamController =
      new StreamController.broadcast();
  StreamController<PLocation> _mapInteractionStreamController =
      new StreamController.broadcast();
  ...
  Future<PLocation> get centerPLocation async {
    Map plocationMap = await _channel.invokeMethod("getCenter");
    return new PLocation(plocationMap["latitude"], plocationMap["longitude"]);
  }
  ...
  Stream<PLocation> get onPLocationUpdated =>
      _LocationChangeStreamController.stream;

  Stream<PLocation> get onMapTapped => _mapInteractionStreamController.stream;
  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    switch (call.method) {
      ...
      case "locationUpdated":
        ...
        _LocationChangeStreamController.add(new PLocation.fromMap(args));
        return new Future.value("");
      ...
      case "infoWindowTapped":
        ...
        return new Future.value("");
      case "mapTapped":
        Map plocationMap = call.arguments;
        PLocation plocation= new PLocation.fromMap(plocationMap);
        _mapInteractionStreamController.add(plocation);
        return new Future.value("");
